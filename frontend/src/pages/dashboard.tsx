...
const Dashboard = () => {
  ...
  const [holidays, setHolidays] = React.useState('Loading...');
  const [imaging_investigations, setImaging_investigations] =
    React.useState('Loading...');
  const [imaging_order_items, setImaging_order_items] =
    React.useState('Loading...');
  const [imaging_orders, setImaging_orders] = React.useState('Loading...');
  const [insurances, setInsurances] = React.useState('Loading...');
  const [invoice_items, setInvoice_items] = React.useState('Loading...');
  const [invoices, setInvoices] = React.useState('Loading...');
  const [lab_order_items, setLab_order_items] = React.useState('Loading...');
  const [lab_orders, setLab_orders] = React.useState('Loading...');
  const [lab_tests, setLab_tests] = React.useState('Loading...');
  const [medications, setMedications] = React.useState('Loading...');
  ...
  const [pharmacy_order_items, setPharmacy_order_items] =
    React.useState('Loading...');
  const [pharmacy_orders, setPharmacy_orders] = React.useState('Loading...');
  const [sick_leaves, setSick_leaves] = React.useState('Loading...');
  const [visits, setVisits] = React.useState('Loading...');
